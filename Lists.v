...
Proof.
  destruct p as [m n]. reflexivity. Qed.
(** [] *)
...
Definition member (v:nat) (s:bag) : bool := (negb (leb (count v s) 0)).
...
Theorem same_numbers_are_equal: forall (n: nat),
    n =? n = true.
Proof.
...
Proof.
  intros b. destruct n.
  - reflexivity.
  - simpl. rewrite same_numbers_are_equal. reflexivity. Qed.
...
Proof.
  induction l as [| n l'].
  - reflexivity.
  - simpl. rewrite <- eqb_refl. rewrite IHl'. reflexivity. Qed.
